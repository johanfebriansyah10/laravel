...
<div class="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-6">
    ...
    <div class="relative mb-8 overflow-hidden rounded-3xl bg-gradient-to-r from-blue-600 via-purple-600 to-purple-700 p-8 shadow-2xl">
        ...
        <div class="relative z-10 text-center">
            ...
            <p class="text-blue-100 text-lg animate-slideUp">
                Perbarui informasi dosen dengan data yang akurat
            </p>
        </div>
    </div>
    ...
    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-gray-100">
            ...
            <div class="bg-gradient-to-r from-green-50 to-blue-50 p-6 border-b border-gray-200">
                <div class="flex items-center justify-between">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4">
                            <h2 class="text-2xl font-bold text-gray-800">Edit Formulir Dosen</h2>
            ...
            <!-- Form Content -->
            <form action="{{ route('dosen.update', $dosen) }}" method="POST" class="p-8" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-10">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="group">
                            ...
                            <input type="text" name="gelar" value="{{ $dosen->gelar }}"
                                   class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all duration-300 group-hover:border-purple-300"
                        ...
                        <div class="group mt-4">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="relative w-48 h-48 rounded-xl overflow-hidden shadow-md border border-gray-200">
                                    <img
                                        src="{{ $dosen->foto ? asset('storage/' . $dosen->foto) : asset('images/placeholder.jpg') }}"
                                        alt="Foto Saat Ini"
                            ...
                            <input
                                ...
                                class="w-full px-4 py-3 rounded-xl border-2 border-gray-200 bg-white/50 backdrop-blur-sm shadow-sm
                                    ...
                                    file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-purple-50 file:text-purple-700
                    ...
                    <div class="bg-gradient-to-r from-amber-50 to-orange-50 rounded-2xl p-6 border-l-4 border-amber-400">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                            <div class="flex items-center text-gray-600">
                                ...
                                Dibuat: {{ $dosen->created_at ? $dosen->created_at->format('d M Y, H:i') : 'N/A' }}
                            </div>
                            <div class="flex items-center text-gray-600">
                                <svg class="w-4 h-4 mr-2 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"></path>
                                </svg>
                                Terakhir diubah: {{ $dosen->updated_at ? $dosen->updated_at->format('d M Y, H:i') : 'N/A' }}
                            </div>
                        </div>
                    </div>
                </div>
