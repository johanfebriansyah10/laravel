    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div class="bg-gradient-to-r from-blue-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300">
            <div class="flex items-center justify-between">
                <div>
                    <p class="text-blue-100 text-sm">Total Dosen</p>
                    <p class="text-3xl font-bold">{{ count($dosen) }}</p>
                </div>
        ...
        <div class="bg-gradient-to-r from-gray-50 to-gray-100 p-6 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <div class="flex items-center gap-2 text-sm text-gray-600">
                    <span>Menampilkan {{ count($dosen) }} data</span>
                        ...
                        <tr class="hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50 transition-all duration-300 group">
                            <td class="p-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="font-mono text-sm bg-gray-100 px-3 py-1 rounded-full">{{ $mhs->nidn }}</span>
                                </div>
                            </td>
                            <td class="p-4">
                            ...
                            <td class="p-4">
                                <div class="flex items-center gap-2">
                                    ...
                                    <form action="{{ route('dosen.destroy', $mhs) }}" method="POST" class="inline">
                                        @csrf
                                        @method('DELETE')
        ...
        <div class="bg-gray-50 p-4 border-t border-gray-200">
            <div class="flex items-center justify-between">
                <div class="text-sm text-gray-600">
                    Menampilkan <span class="font-medium">1</span> sampai <span class="font-medium">{{ count($dosen) }}</span> dari <span class="font-medium">{{ count($dosen) }}</span> hasil
                </div>
                <div class="flex items-center gap-2">
