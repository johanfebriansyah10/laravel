...
>
    ...
    <div class="p-6 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
        <h1 class="text-2xl font-bold text-indigo-600 dark:text-indigo-400">Admin Dashboard</h1>
        <button
    ...
    <nav class="flex flex-col mt-6 space-y-2 text-sm font-medium px-4">
        ...
        <a
            href="{{ route('logout') }}"
            class="flex items-center px-4 py-3 rounded-lg hover:bg-red-100 dark:hover:bg-red-800 hover:text-red-600 dark:hover:text-red-400 transition-all duration-200 group"
        >
